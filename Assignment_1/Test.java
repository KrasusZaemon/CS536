...
public class Test {
    ...
    private static void testExceptions() {
        ...
        try {
            ...
            error("SymTable.addDecl", 
                  "wrong exception thrown on addDecl(null, sym), but this is ok");
        }
        ...
        try {
            ...
            error("SymTable.addDecl", 
                  "wrong exception thrown on addDecl(name, null),but this is ok");
        }
        ...
        try {
            ...
            error("SymTable.addDecl", 
                  "wrong exception thrown on addDecl(null, null), but this is ok");
        }
    }
        ...
        try { 
            ...
            try {
                ...
                error("SymTable.lookupLocal", "unexpected exception for " +
                      "lookup in SymTable with no maps, but this is ok");
            }
